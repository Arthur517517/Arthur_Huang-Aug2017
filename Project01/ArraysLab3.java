...
/**
 * This class contains various methods that manipulate the values inside several arrays.
 *
 * Arthur Huang
 * 11/2/2017
 */
public class ArraysLab3
{
   public static void main(String[] args){
       ...
       System.out.println("Array after calling method sum: " + Arrays.toString(sumArr));
       
       int appendNum = 200;
       int[] appendArr = append(a1, appendNum);
       System.out.println("Array after calling method append: " + Arrays.toString(appendArr));
       
       int removeIdx = 5;
       int[] removeArr = remove(a2, removeIdx);
       System.out.println("Array after calling method remove: " + Arrays.toString(removeArr));
       
       int sumOfEvens = sumEven(appendArr);
       System.out.println("Result after calling method sumEven: " + sumOfEvens);
   ...
   public static int[] sum(int[] arr1, int[] arr2){
       ...
       for(int i = 0; i < arr3.length; i++){
           arr3[i] = arr1[i] + arr2[i];//adds the elements in the two arrays, store it in arr3
       }
       return arr3;
   }
   /*
   ...
   public static int[] append(int[] arr, int num){
       int[] newArr = new int[arr.length + 1];//declare a new array with the length of arr + 1
   ...
   public static int[] remove(int[] arr, int idx){
       ...
       for(int i = 0; i < idx; i++){//loop until the specified index
           removedArray[i] = arr[i];
       }
       for(int i = idx; i < arr.length - 1; i++){//loop through the rest of the elements
           removedArray[i] = arr[i + 1]; 
       }
       return removedArray;
   }
   /*
   ...
   public static int sumEven(int[] arr){
       int sum = 0;
       for(int i = 0; i <= arr.length; i += 2){//increment by 2, this will only give elements with even indicies
           sum += arr[i];
       }
       return sum;
   }
   ...
   public static void rotateRight(int[] arr){
       int tempLast = arr[arr.length - 1];//store the last element in a temp variable
       for(int i = arr.length -1; i > 0; i--){//loop backwards
           arr[i] = arr[i - 1];
       }
       arr[0] = tempLast;
       System.out.println("Array after calling method rotateRight: " + Arrays.toString(arr));
   }
}
